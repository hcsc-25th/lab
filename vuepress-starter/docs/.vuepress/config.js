module.exports = {
  ...
  base: '/lab/',
  head: [
    ['link', { rel: 'icon', href: 'https://hcsc-25th.github.io/s/img/profilePicture-20210612-nobackground.png' }]
  ],
  themeConfig: {
    logo: 'https://hcsc-25th.github.io/s/img/profilePicture-20210612-nobackground.png',
    nav: [
